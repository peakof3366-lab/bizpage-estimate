...
const EXPECT = {
  ...
  '다낭':     'mid|asiaMid|동남아|VND|danang|',
  '나트랑':    'mid|asiaMid|동남아|VND|nhatrang|',
  '푸꾸옥':    'mid|asiaMid|동남아|VND|seasia|',
  '세부':     'mid|asiaMid|동남아|PHP|philippines|',
  '마닐라':    'mid|asiaMid|동남아|PHP|philippines|',
  '보홀':     'mid|asiaMid|동남아|PHP|philippines|',
  '코타키나발루': 'mid|asiaMid|동남아|MYR|kotakinabalu|',
