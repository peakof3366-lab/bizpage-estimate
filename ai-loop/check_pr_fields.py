...
() => {
  const data = {
    ...
    evidence: {
      airfare:{rowIdx:0,line:'항공료 …',calc:'700,000 × 19 × 1 = 13,300,000',label:'항공료',via:'rule'},
      fuel:{rowIdx:1,line:'유류 …',calc:'135,300 × 19 × 1 = 2,570,700',label:'유류할증료 및 택스',via:'rule'},
      hotel:{rowIdx:2,line:'노보텔 …',calc:'224,750 × 26 × 3 = 17,530,500',label:'노보텔',via:'rule'},
      hotelName:{calc:'노보텔',label:'노보텔',via:'rule'},
      meal:{rowIdxs:[3,4],calc:'식사 총액 7,049,936 ÷ 인원 26 ÷ 3일 = 90,384 (1인 1일)',label:"식사 13줄 · 라벨의 'N일' 3개",via:'calc'},
      vehicle:{rowIdx:5,line:'차량 …',calc:'797,500 × 1 × 4 = 3,190,000',label:'29인승 차량',via:'rule'},
      guide:{rowIdx:6,line:'가이드 …',calc:'217,500 × 2 × 4 = 1,740,000',label:'한국인 가이드',via:'ai'},
      sight:{rowIdxs:[7],calc:'관광 총액 3,632,782 ÷ 인원 26 = 139,722 (1인당 전 일정)',label:'관광 3줄',via:'calc',
