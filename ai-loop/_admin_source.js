...
const ADMIN_PARTS = ['admin.html', 'admin.css', 'admin/common.js', 'admin/ledger.js', 'admin/packages.js', 'admin/recommend.js', 'admin/itinerary.js', 'admin/pricereport.js', 'admin/rates.js'];
