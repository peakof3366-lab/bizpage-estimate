...
const BIZ_ZONES = {
  ...
  mid:   ['싱가포르','하노이','호치민','다낭','나트랑','푸꾸옥',
          ...
          '방콕','푸켓','치앙마이','발리','라오스',
          '우즈베키스탄','카자흐스탄',
          '시드니','멜버른','호주','오클랜드','괌','사이판'],
  long:  ['영국','파리','로마','독일','네덜란드','스페인','동유럽','북유럽','서유럽',
          '로스앤젤레스','샌프란시스코','뉴욕','워싱턴','하와이','밴쿠버','토론토'],
};
...
const ITINERARY_DB = {
  ...
  '코타키나발루': [
    {
      ...
      days: [
        ...
        { day:5, title:'정리 · 귀국', am:'세계 3대 석양 감상·자유시간', pm:'공항 이동', eve:'귀국', tip:'출발 2시간 반 전 도착 권장' },
      ],
    },
    {
  ...
  '치앙마이': [
    ...
    },
    {
      ...
      days: [
        ...
        { day:3, title:'사원 · 요리 체험', am:'도이수텝 사원 트레킹·일몰 감상', pm:'태국 쿠킹 클래스(북부 요리)', eve:'팀 만찬', tip:'쿠킹 클래스는 사전 식자재 알레르기 확인' },
  ...
  '카자흐스탄': [
    {
      ...
      days: [
        ...
        { day:4, title:'도시 탐방', am:'아스타나 미래 건축(바이테렉 타워 등) 야경 투어', pm:'자유시간', eve:'팀 만찬', tip:'겨울철 매우 추움 — 방한 대비 필요' },
  ...
  '호주': [
    ...
    },
    {
      ...
      subtitle: '황금 해변과 세계 최고 산호초에서 팀 모두가 즐기는 완벽한 골드코스트 연수',
      highlights: ['골드코스트 서핑 레슨 팀 체험','무비월드 테마파크 자유 이용','그레이트 배리어 리프 다이빙 투어','서퍼스 파라다이스 야시장 탐방'],
      days: [
        ...
        { day:4, title:'산호초 투어', am:'그레이트 배리어 리프 다이빙·스노클링 투어(당일)', pm:'투어 계속', eve:'팀 만찬', tip:'선박 이동시간을 고려한 이른 출발 필요' },
        { day:5, title:'자유시간 · 귀국', am:'서퍼스 파라다이스 야시장 탐방·쇼핑', pm:'공항 이동', eve:'귀국', tip:'출발 3시간 전 도착 권장' },
      ],
    },
  ],
  ...
  '네덜란드': [
    {
      ...
      days: [
        ...
        { day:3, title:'반도체 · 연구', am:'ASML 반도체 장비 혁신 센터 방문', pm:'델프트 공대 혁신 연구소 방문', eve:'팀 만찬', tip:'ASML 견학은 6주 전 신청 필요(보안 절차)' },
  ...
  '스페인': [
    {
      ...
      highlights: ['IE 비즈니스스쿨 유럽 경영 강의','SEAT 자동차 공장·혁신센터 견학','바르셀로나 22@ 스타트업 구역 탐방','스페인 태양광·신재생에너지 현장'],
      days: [
        ...
        { day:3, title:'스타트업 탐방', am:'바르셀로나 22@ 스타트업 구역 탐방', pm:'IE 비즈니스스쿨 유럽 경영 강의', eve:'팀 만찬', tip:'22@ 지구는 도보 투어 추천' },
  ...
  '동유럽': [
    ...
    },
    {
      ...
      days: [
        ...
        { day:2, title:'프라하 야경', am:'프라하 천문시계·구시가 광장 야경 탐방', pm:'카를교 산책', eve:'팀 저녁', tip:'야경 투어는 저녁 늦게 진행' },
  ...
  '북유럽': [
    {
      ...
      highlights: ['KTH·알토대학 미래 기술 강의','노르딕 스타트업 생태계 탐방','덴마크 복지 행정 현장 방문','북유럽 그린에너지 혁신 현장'],
      days: [
        ...
        { day:4, title:'복지 행정', am:'덴마크 복지 행정 현장 방문(연계 프로그램)', pm:'브리핑 계속', eve:'팀 만찬', tip:'복지기관 방문은 6주 전 신청 필요' },
        { day:5, title:'정리 · 귀국', am:'자유시간·쇼핑', pm:'공항 이동', eve:'귀국', tip:'출발 3시간 전 도착 권장' },
      ],
    },
    {
  ...
  '토론토': [
    ...
    },
    {
      ...
      days: [
        ...
        { day:4, title:'아일랜드 크루즈', am:'토론토 아일랜드 선셋 크루즈', pm:'자유시간', eve:'재즈·블루스 공연 관람', tip:'공연장 사전 예약 권장' },
        { day:5, title:'자유시간 · 귀국', am:'쇼핑', pm:'공항 이동', eve:'귀국', tip:'출발 3시간 전 도착 권장' },
      ],
    },
  ],
